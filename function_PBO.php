...
function affichProduct($bdd){
    ...
    $reponse = $bdd->query('Select productName, description, price, image FROM product');
    while ($donnees = $reponse->fetch()) { ?>
        ...
        <div class="media mb-3">
            ...
            <div class="form-check align-self-center col-2">
                <input type="checkbox" name="test" class="form-check-input" id="test">
                <label class="form-check-label" for="test">Selectionner</label>
            </div>
        </div>
    <?php
    }
